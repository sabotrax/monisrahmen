...
<img src="pictures/assembly-1.jpg" width="400">

### Step 1

Push 8 M2.5 screws through the mounting holes from the bottom side up.

<img src="pictures/assembly-1-3.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-1-2.jpg" width="400">

### Step 2

Screw 8 M2.5 standoffs onto the screws.

<img src="pictures/assembly-2.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-2-2.jpg" width="400">
...
<img src="pictures/assembly-3.jpg" width="400">
...
<img src="pictures/assembly-4.jpg" width="400">

Mount the Raspberry Pi and sensor board onto the standoffs and tighten them down with 8 M2.5 nuts.

<img src="pictures/assembly-4-2.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-4-3.jpg" width="400">
...
<img src="pictures/assembly-5.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-5-2.jpg" width="400">

### Step 6

Connect the HDMI ports of the Raspberry Pi and the daughter board of the display with the HDMI cable.

<img src="pictures/assembly-6.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-6-2.jpg" width="400">
...
<img src="pictures/assembly-7.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-7-2.jpg" width="400">
...
<img src="pictures/assembly-8.jpg" width="400">

Put the frame over the display passing the FPC table up through the frame.

<img src="pictures/assembly-8-2.jpg" width="400">

Connect the FPC cable to the HDMI board.

<img src="pictures/assembly-8-3.jpg" width="400">
...
<img src="pictures/assembly-9-2.jpg" width="400">

### Step 10

Sand down the skewed part of the frame stand so it can fit in the mounting slot.

<img src="pictures/assembly-10.jpg" width="400">

The outcome should look like this:

<img src="pictures/assembly-10-2.jpg" width="400">
